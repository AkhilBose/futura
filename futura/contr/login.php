    ...
    $query = "select * from  user where email = '$email' and password = '$password' " ;
     ...
     if($result)
     {
         if (mysqli_num_rows($result) > 0)
         {
             ...
             if (mysqli_num_rows(mysqli_query($con,"select * from  user where email = '$email' and password = '$password' and iscontri != '0'")) == 0)
             {
            
               //  echo "hi"; die();
                 
                   echo "<script>alert('Not Yet a Contributer');window.location.assign('login.php'); </script>";
            ...
            $name = $row['username']; 
             ...
             header("location:courseexplore.php");
             }
