					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-5 col-lg-6">
							<div class="single-team__info1">
								...
								<!-- <h3 class="single-team__info-title">Samuel Williams</h3> -->
								<ul class="single-team__info-list">
								<li>
                                    <span>Name:</span>
                                    <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="Samuel Williams">
								</li>
                                        
									<li>
                                        <span>Department:</span>
                                    <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="Mathematics">
                                    
									</li>
									<li>
                                        <span>Appointment:</span>
                                    <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="Professor">
                                    
									</li>
									<li>
                                        <span>Job:</span>
                                        <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="Professor of Mathematics">
                                        
									</li>
									<li>
                                        <span>Experience:</span>
                                        <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="20 Years">
									...
									<li>
                                        <span>Category:</span>
                                        <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="1 Category">
                                        
									</li>
									<li>
                                        <span>Phone:</span>
                                        <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="856 263 4561">
                                        
									</li>
									<li>
										<span>Email:</span><input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="asdfgh@gmail.com">
					...
					<div class="row">
						<div class="col-lg-12">
                            <div class="single-team__info1">
								...
								<ul class="single-team__info-list">
								<li><span>Biography
                            <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="Lorem ipsum dolor sit amet, consectetur adipiscing elit.">
                        </span></li>
                        
                        <li><span>Personal Experience</h3>
							<input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" placeholder="Name" value="Vivamus eu ullamcorper mi. Morbi vitae lectus non ligula">
                            </span></li>
                            </ul>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="reply-form">
								...
								<form action="userupdate.php" class="reply-form__form">
									...
									<div class="reply-form__box-05">
										<button class="btn-01" type="submit">Update Profile</button>
									</div>
								</form>
							</div>
						</div>
