...
-->
									...
									<li>
                                        <span>Email</span>
                                    <input name="email" type="text" class="reply-form__name form-in-wrapp-validates-as-required" value="<?php echo $query['email']; ?>">
                                    
									</li>
									<li>
                                        <span>Ph NO:</span>
                                    <input name="phno" type="text" class="reply-form__name form-in-wrapp-validates-as-required" value="<?php echo $query['phno']; ?>">
                                    
									</li>
									<li>
                                        <span>Qualification:</span>
                                        <input name="name" type="text" class="reply-form__name form-in-wrapp-validates-as-required" value="<?php echo $query['quali']; ?>">
